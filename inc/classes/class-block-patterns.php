...
class Block_Patterns {
    ...
    if ( function_exists( 'register_block_pattern' ) ) {
      ...
      register_block_pattern(
        ...
        [
          ...
          'description' => _x( 'Aquila', 'Aquila two columns with heading and text', 'aquila' ),
          'categories' => [ 'zcolumns' ],
  ...
  public function register_block_pattern_categories() {
    $patterns_categories = [
      ...
      'zcolumns' => __( 'Columns', 'aquila'),
    ];

    if ( ! empty($patterns_categories) && is_array( $patterns_categories ) ) {
      foreach( $patterns_categories as $pattern_category => $pattern_category_label  ) {
