...
<?php
  ...
  public function save_post_meta_data( $post_id ) {
     ...
     * Check if the current user is authoried
     */
    ...
    /**
     * Check if the nonce value we received is the we created.
     */
    if ( ! isset( $_POST['hide_title_meta_box_nonce_name'] ) ||
      ! wp_verify_nonce( 'hide_title_meta_box_nonce_name', plugin_basename(__FILE__) ) ) {
      return;
    }
