...
function aquila_posted_on() {
  ...
  echo '<span class="posted-one text-secondary">'. $post_on .'</span>';
}
...
function aquila_the_excerpt( $trim_character_counter = 0 ) {
  if ( ! has_excerpt() || 0 === $trim_character_counter ) {
    the_excerpt();
    return;
  }

  $excerpt = wp_strip_all_tags( get_the_excerpt() );
  $excerpt = substr( $excerpt, 0, $trim_character_counter );
...
function aquila_pagination() {
  ...
  $args = [
    'before_page_number' => '<span class="btn btn-outline-secondary me-2 mb-2">',
