 ...
 * 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
 * @package aquila
 */
?>
<section class="no-result not-found">
  <header class="page-header">
    ...
    <div class="page-content">
      ...
      <p><?php esc_html_e('Sorry but nothing matched your search item. Please try again with some diffrent keywords', 'aquila'); ?></p>
      <?php
          get_search_form();
        } else { ?>
